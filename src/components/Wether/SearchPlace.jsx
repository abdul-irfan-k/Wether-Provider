...
const SearchPlace = () => {
    ...
    return (
        <>
            <div className='w-auto  md:w-1/3 flex-col relative  mx-auto  z-20'>
                <div className='relative  '>
                    <div className='flex bg-slate-200 dark:bg-stone-800   rounded-full mx-auto'>
                        ...
                        <input type="text" placeholder='search city' onChange={(e) => setPlaceName(e.target.value)} className='w-[70%] ml-1 bg-inherit border-none  hover:border-none focus:outline-none' />
                    </div>
